    ...
    return (
        <div className='w-full'>
            <div className='w-full mb-5'>
                ...
                <input type='text' className='w-1/2  p-2 rounded-lg border-2 text-black ' placeholder='Enter Email' />
            </div>

            {
                emailSubmit && <div className='w-full mb-5'>
                    <div>Enter your OTP</div>
                    <input type='text' className='w-1/2  p-2 rounded-lg border-2 text-black ' placeholder='Enter OTP' />
                </div>
            }

{
                otpValidate && <div className='w-full mb-5'>
                    ...
                    <input type='text' className='w-1/2  p-2 rounded-lg border-2 text-black ' placeholder='Enter New Password' />
                </div>
            }
